...
exports.fluttercreateProduct = catchAsyncErrors(async (req, res, next) => {
  console.log(req.body);

  // Assuming the client sends the image data as base64 in the 'images' field
...
exports.getCartItems = async (req, res, next) => {
  try {
    ...
    if (!cart) {
      return res
        .status(400)
        .json({ success: false, error: "User cart not found " });
    }
